...
namespace levi_rs::bridge
{
        ...
        LeviRsStrSink reply)
    {
        ...
        // A disabled mod is reported as absent rather than failing: "not there
        // right now" is exactly what a disabled provider is, and callers
        // already have to handle it.
        if (!provider->isEnabled()) return LEVI_RS_SERVICE_NOT_FOUND;
