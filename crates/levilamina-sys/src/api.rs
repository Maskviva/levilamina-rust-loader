...
pub struct LeviRsApi {
    ...
    pub lane_publish: unsafe extern "C" fn(
        mod_: LeviRsModHandle,
        name: LeviRsStr,
        desc: *const LeviRsLaneDesc,
    ) -> u64,
    pub lane_unpublish: unsafe extern "C" fn(mod_: LeviRsModHandle, pub_id: u64) -> bool,
    pub lane_acquire: unsafe extern "C" fn(
        mod_: LeviRsModHandle,
        name: LeviRsStr,
        want_fingerprint: u64,
        out: *mut LeviRsLaneRef,
    ) -> i32,
    pub lane_release: unsafe extern "C" fn(mod_: LeviRsModHandle, lease: u64) -> bool,
    pub lane_list: unsafe extern "C" fn(ctx: *mut c_void, sink: LeviRsStrSink),

    pub md_list_dimensions: unsafe extern "C" fn(ctx: *mut c_void, sink: LeviRsStrSink),

    pub level_delete_chunk_keys: unsafe extern "C" fn(dim: i32, chunk_x: i32, chunk_z: i32) -> i32,

    pub level_chunks_loaded:
        unsafe extern "C" fn(dim: i32, min_x: i32, min_z: i32, max_x: i32, max_z: i32) -> i32,

    pub player_conn_id: unsafe extern "C" fn(who: LeviRsPlayerSel) -> u64,

    pub level_chunk_keys: unsafe extern "C" fn(
        dim: i32,
        chunk_x: i32,
        chunk_z: i32,
        ctx: *mut c_void,
    ...
    pub level_delete_key: unsafe extern "C" fn(key: LeviRsStr) -> bool,

    pub level_set_biome: unsafe extern "C" fn(
        dim: i32,
        min_x: i32,
        min_z: i32,
        max_x: i32,
