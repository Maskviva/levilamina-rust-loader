...
fn main() {
    ...
    println!("cargo:warning=⚠️  WARNING: THIS VERSION IS DEPRECATED AND HAS VULNERABILITIES!");
    println!("cargo:warning=Please migrate to the new rewritten repository.");
    println!("cargo:warning=New Project: https://github.com/Maskviva/Pier");
    println!("cargo:warning=========================================================");
