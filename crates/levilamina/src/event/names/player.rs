...
pub const PLAYER_DISCONNECT: &str = "PlayerDisconnectEvent";
pub const PLAYER_DIE: &str = "PlayerDieEvent";
pub const PLAYER_RESPAWN: &str = "PlayerRespawnEvent";
pub const PLAYER_JUMP: &str = "PlayerJumpEvent";
...
pub const PLAYER_SPRINTING: &str = "PlayerSprintingEvent";
pub const PLAYER_SPRINTED: &str = "PlayerSprintedEvent";
