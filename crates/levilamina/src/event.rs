...
/// Any unique suffix subscribes, but using these constants keeps you off
/// the "class was renamed upstream" treadmill.
pub mod names {
    // player
    ...
    // server / commands (typed side-channel in the bridge)
